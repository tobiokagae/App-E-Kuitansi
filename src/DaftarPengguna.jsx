      ...
      <main className="main-content">
        ...
        <div className="pagination-container2">
          ...
          <div className="button-page">
            <button className="previous-page" onClick={handlePrevious}>
        ...
        {showDeleteModal && (
          <div className="modal-overlay">
            <div className="modal-content">
              <p>Apakah Anda yakin ingin menghapus data milik <strong>{selectedUser?.nama}</strong>?</p>
              <div className="modal-buttons">
                <button onClick={confirmDelete}>Ya</button>
                <button onClick={cancelModal}>Batal</button>
              </div>
            </div>
          </div>
        )}
